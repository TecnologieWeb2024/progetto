...
<div class="container mt-4">
    <?php if (empty($formatted_notifications)): ?>
        <div class="bg-primary-subtle text-center p-5 rounded-3 w-50 justify-content-center align-items-center mx-auto">
            Non hai notifiche.
        </div>
    <?php else: ?>
        ...
        <div class="mt-4 text-center align-items-center justify-content-center">
            ...
            <button class="btn btn-danger" onclick="deleteAllNotifications()">Elimina tutte</button>
