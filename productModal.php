                    ...
                    <div class="container modal-body d-flex p-0 pt-4">
                        ...
                        <div class="col-md-6 col-8 d-flex flex-column">
                            <div class="row">
                                ...
                                <?php if (isUserSeller()): ?>
                                    <p class="text-muted">In magazzino: <span id="modalProductStock">0</span></p>
                                    <p class="text-muted">ID prodotto: <span id="modalProductId">0</span></p>
                                <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3">
                                <?php if (isUserCustomer()) : ?>
                                    <div class="d-flex align-items-center border border-1 rounded ms-2 me-2">
                                        ...
                                        <input type="number" id="modalQuantity" name="quantity" class="form-control text-center rounded rounded-0" value="1" min="1" max="1" style="width:3em">
